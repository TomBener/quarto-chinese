...
\usepackage{etoolbox}
% In the bibliography, don't insert CJK–Latin glue around ASCII [ and ].
\AtBeginEnvironment{CSLReferences}{\normalspacedchars{[]}}

% \setlength{\cslhangindent}{2em}   % change hanging indent width
% \setlength{\csllabelwidth}{3em}   % if you also redefine left/right macros elsewhere
